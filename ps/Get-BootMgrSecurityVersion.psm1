...
function Get-BootMgrSecurityVersion {
    [CmdletBinding()]
    param(
    ...
    $SVN_bytes = Get-BootMgrSecurityVersionBytes -Path $Path
    if ([string]::IsNullOrEmpty($SVN_bytes)) { 
        return $null 
    }
...
# Code below was generated by Google AI
